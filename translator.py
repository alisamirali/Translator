...
# mail:
# alisamiralizaki.2020@gmail.com

# LinkedIn profile:
# https://www.linkedin.com/in/ali-samir-ali/
# ------------------------------------------


# Import Suitable Modules
from tkinter import *
import tkinter
...
root.maxsize(530, 530)
root.minsize(530, 530)


# Functions that perform translation and clear the fields
def translate():
...
l = tkinter.StringVar()
choose_language = ttk.Combobox(root, width=20, textvariable=l,
                               state='readonly', font=('verdana', 10, 'bold'))

# List Of Languages
choose_language['values'] = (
    'Afrikaans', 'Albania', 'Arabic', 'Armenian',
    'Azerbaijani', 'Basque', 'Belarusian',
    'Bengali', 'Bosnian', 'Bulgarian',
    'Catalan', 'Cebuano', 'Chichewa',
    ...
    'Khmer', 'Kinyarwanda Korean', 'Kurdish', 'Kyrgyz',
...
button = Button(root, text='Translate', relief=RIDGE,
                borderwidth=3, font=('verdana', 10, 'bold'),
                cursor="hand2", command=translate)
